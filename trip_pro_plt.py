...
# file_name = node_label_nam
# label_name = 'original-data\contact-primary-school-classes-gender/node-labels-get.txt'
edge_name = 'tripadvisor-data/tripadvisor/hyperedges-tripadvisor.txt'
